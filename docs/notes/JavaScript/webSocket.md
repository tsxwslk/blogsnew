...
permalink: /JavaScript/hhds9gsk/
---
:::info
之前做的一个可视化大屏项目中可多人同时配置一个大屏，其中一人保存修改后需提示其他同时编辑的用户“大屏内容有修改”，用户可自行选择是否同步修改。此功能的实现是通过websocket来完成的，每当有用户执行保存操作的同时，我们利用客户端向服务器发送信息，再有服务器向客户端发送信息实现推送功能。
:::
## WebSocket 介绍
